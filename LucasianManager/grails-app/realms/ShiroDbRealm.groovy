...
import com.lucasian.manager.Usuario
import com.lucasian.manager.Rol
...
class ShiroDbRealm {
    ...
    def authenticate(authToken) {
        ...
        // in the database.
        def account = new SimpleAccount(user, user.passwordHash, "ShiroDbRealm")
    ...
    def isPermitted(principal, requiredPermission) {
        ...
        def user = Usuario.findByUsername(principal.username)
        ...
        def results = Usuario.executeQuery("select distinct p from Usuario as user join user.roles as role join role.permissions as p where user.username = '$principal'")
